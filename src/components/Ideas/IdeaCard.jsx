...
const IdeaCard = ({ idea }) => {
  ...
  // একদম সহজ উপায়ে ভ্যালিড ইউআরএল চেক করা
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        ...
        <div className="space-y-3 pt-3 border-t border-zinc-100 dark:border-zinc-900">
          ...
          <Link href={`ideas/${idea?._id}`} className="block w-full">
            <button className="w-full py-3 cursor-pointer text-sm font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl transition-all duration-200 active:scale-[0.98] shadow-lg shadow-blue-500/10">
              View Details
            </button>
          </Link>
        </div>
