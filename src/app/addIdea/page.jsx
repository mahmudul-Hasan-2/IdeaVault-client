  ...
  return (
    <div className="space-y-5 px-2">
      ...
      <form
        ...
        className="border border-gray-200 py-8 px-5 space-y-5"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          <div className="py-5">
            <label>EstimatedBudget</label>
            <input
              type="text"
              name="estimatedBudget"
              className="input w-full h-full mt-2"
              placeholder="Enter Idea estimatedBudget (optional)"
            />
          </div>
          <div className="py-5">
            ...
            <input
              ...
              name="targetAudience"
              className="input w-full h-full mt-2"
              placeholder="Enter Idea targetAudience"
            />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2  gap-6 lg:gap-10">
          ...
          <div className="py-5">
            ...
            <textarea
              ...
              className="input w-full h-40 mt-2 resize-none text-wrap"
